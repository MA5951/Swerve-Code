...
public class SwerveSubsystem extends SubsystemBase {
  ...
  private LoggedSwerveStates gyroStates;
  private LoggedDouble angle;
  private double angleSwerve = 0;
  ...
  public SwerveSubsystem() {
    ...
    gyroStates = new LoggedSwerveStates("/Swerve/Gyro cahssis speed");
    angle = new LoggedDouble("/Swerve/Angle");
