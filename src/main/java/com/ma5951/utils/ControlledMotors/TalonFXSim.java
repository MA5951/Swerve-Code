...
import com.ma5951.utils.Utils.Derivative;
...
public class TalonFXSim extends SimMotor {
    ...
    public TalonFXSim(
            ...
            boolean isKraken) 
        {
            super(model, DCMotor.getKrakenX60(numMotors), gearing, conversionFactor);
    ...
    public TalonFXSim(
            int numMotors, double gearing, double jKgMetersSquared, double conversionFactor , boolean isKraken) {
                super(DCMotor.getKrakenX60(numMotors), jKgMetersSquared,  gearing,  conversionFactor);
    }
    ...
    public double getVelocity() {
        return ConvUtil.RPMtoRPS(motorSim.getAngularVelocityRPM()) * conversionFactor;
    }
